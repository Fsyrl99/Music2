...
def stream_markup_timer(_, vidid, chat_id, played, dur):
    ...
    buttons = [
       ...
       [
            InlineKeyboardButton(text="Group",rl="https://t.me/Night_Shdeeeee"),
...
def stream_markup(_, videoid, chat_id):
    buttons = [
       ...
       [
            InlineKeyboardButton(text="Group", url="https://t.me/Night_Shdeeeee"),
        InlineKeyboardButton(text=_["CLOSE_BUTTON"], callback_data="close")],
    ]
    return buttons
...
def stream_markup2(_, chat_id):
    buttons = [
       ...
       [
            InlineKeyboardButton(text="Owner", url="https://t.me/Night_Shdeeeee"),
        InlineKeyboardButton(text=_["CLOSE_BUTTON"], callback_data="close")],
    ]
    return buttons
